window.view = {
	...
	validateRectangleInputs: function() {
		...
		if ( a !== '2')
			alert('Incorrect value of input variables(arguments). Calculating the area of a right-angled-triangle requires the length of the two different parallel sides of the rectangle. Try again.')
		else if ( b !== 'float' )
